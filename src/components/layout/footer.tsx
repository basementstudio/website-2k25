...
export const Footer = () => (
  <Pump queries={[query]}>
    {async ([data]) => {
      ...
      return (
        <footer className="relative z-10 flex h-[90vh] max-h-[840px] flex-col justify-between bg-brand-k pb-4">
          <Grid />
          ...
          <div className="grid-layout relative items-end">
            ...
            <div className="col-start-11 col-end-13 flex flex-col items-end gap-y-4">
...
const SocialLinks = ({ className, links }: SocialLinksProps) => (
  <div className={cn("!text-p text-brand-g1", className)}>
