...
export const Values = ({ data }: { data: ValueItem[] }) => (
          ...
          >
            ...
            >
              {idx === 0 && (
                <h2
                  className={cn(
                    "col-span-full bg-brand-k pb-6 !text-f-h3-mobile text-brand-g1 lg:!text-f-h3",
              ...
              >
                ...
                <div className="col-span-full !text-pretty text-f-h4-mobile text-brand-w2 sm:col-span-2 md:text-f-h4 lg:col-start-9 lg:col-end-13">
