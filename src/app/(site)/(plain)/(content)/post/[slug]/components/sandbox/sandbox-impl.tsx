...
// Loaded via `dynamic(ssr: false)` from ./index — Sandpack reads `Date.now()`
// at render, which can't run during prerender under Cache Components.
export default function SandboxImpl({ keyName }: SandboxComponentProps) {
