export const ContactStatus = ({
  ...
  return (
    <div className="flex items-center gap-2">
      {isSubmitting && (
        <p className="text-f-h3-mobile text-[#E6E6E6] xl:text-h4">
          Submitting...
        </p>
      )}
      ...
      {isSubmitted && !isSubmitting && (
        <>
          <p className="text-f-h3-mobile text-[#00FF9B] xl:text-h4">
            Form submitted
          </p>
          <svg
            width="20"
      ...
      {error && !isSubmitting && (
        <>
          <p className="text-f-h3-mobile text-[#F32D2D] xl:text-h4">{error}</p>
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
