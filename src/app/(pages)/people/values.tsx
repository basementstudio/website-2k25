      ...
      <div className="flex w-full flex-col">
        {data.company.ourValues.valuesList.items.map(
          ({ _title, image, description }, idx) => (
            <div
              className={cn(
                "grid-layout relative mb-4 !gap-y-4 px-4 pt-4 lg:!gap-y-2 lg:pt-4",
                idx !== 0 &&
                ...
                idx === data.company.ourValues.valuesList.items.length - 1 &&
                  "mb-0 before:absolute before:-bottom-4 before:left-4 before:w-[calc(100%-32px)] before:border-b before:border-brand-w1/20"
              )}
              key={idx}
            >
