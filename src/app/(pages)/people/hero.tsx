...
export const Hero = ({ data }: { data?: QueryType }) => {
  return (
    ...
    >
      ...
      <div className="col-span-full flex max-w-[34.6875rem] flex-col gap-4 lg:col-start-5 lg:col-end-9 [&_p]:text-balance [&_p]:text-mobile-h2 lg:[&_p]:text-h2">
        <RichText>{data?.pages.people.subheading1?.json.content}</RichText>
      </div>
      <div className="col-span-full flex max-w-[34.6875rem] flex-col gap-4 lg:col-start-9 lg:col-end-13 [&_p]:text-balance [&_p]:text-mobile-h2 lg:[&_p]:text-h2">
