...
export const Hero = ({ data }: { data?: QueryType }) => (
  ...
  >
    ...
    <div className="[&_p]:text-f-h2-mobile lg:[&_p]:text-f-h2 col-span-full flex flex-col gap-4 lg:col-start-5 lg:col-end-9 [&_p]:!text-pretty">
      <RichText>{data?.pages.people.subheading1?.json.content}</RichText>
    </div>
    <div className="[&_p]:text-f-h2-mobile lg:[&_p]:text-f-h2 col-span-full flex flex-col gap-4 lg:col-start-9 lg:col-end-13 [&_p]:!text-pretty">
