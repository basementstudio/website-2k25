  ...
  return (
    <section className="grid-layout">
      <article className="col-span-8 flex flex-col gap-6">
        <div className="[&_p]:text-h1">
          <RichText>{data.pages.homepage.intro.title?.json.content}</RichText>
        </div>

        <div className="max-w-[50%] [&_p]:text-h4">
          <RichText>
...
const B = () => {
  return (
    <div className="with-dots grid aspect-video w-full place-items-center border border-brand-w1/20 text-brand-w1">
      <svg
