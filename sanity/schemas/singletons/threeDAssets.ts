...
export const threeDAssets = defineType({
  ...
  deprecated: {
    reason:
      "3D assets and metadata moved to the repo under public/3d/ and src/lib/3d-config/. This document is no longer read by the app and will be deleted soon. Do not edit."
  },
  readOnly: true,
